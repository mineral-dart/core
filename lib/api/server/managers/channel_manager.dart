...
final class ChannelManager {
  ...
  ChannelManager(this._channels, this.threads, Map<String, dynamic> json) {
    _namedChannels
  ...
  factory ChannelManager.fromList(List<ServerChannel> channels, List<ThreadChannel> threads, payload) {
