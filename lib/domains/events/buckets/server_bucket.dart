...
final class ServerBucket {
  ...
  void messageUpdate(ServerMessageUpdateEventHandler handle) =>
      _events.make(Event.serverMessageUpdate, handle);

  void messageDelete(ServerMessageDeleteEventHandler handle) =>
      _events.make(Event.serverMessageDelete, handle);

  void messageReactionAdd(ServerMessageReactionAddEventHandler handle) =>
      _events.make(Event.serverMessageReactionAdd, handle);

  void messageReactionRemove(ServerMessageReactionRemoveEventHandler handle) =>
      _events.make(Event.serverMessageReactionRemove, handle);

  void messageReactionRemoveAll(ServerMessageReactionRemoveAllEventHandler handle) =>
      _events.make(Event.serverMessageReactionRemoveAll, handle);

  void messageReactionRemoveEmoji(ServerMessageReactionRemoveEmojiEventHandler handle) =>
      _events.make(Event.serverMessageReactionRemoveEmoji, handle);
}
