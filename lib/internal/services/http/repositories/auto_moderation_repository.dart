...
final class AutoModerationRepository {
  ...
  /// ```
  String list(String guildId) => Uri(pathSegments: ['guilds', guildId, 'auto-moderation', 'rules']).path;
  ...
  /// ```
  String get(String guildId, String ruleId) =>
  ...
  /// ```
  String create(String guildId) => Uri(pathSegments: ['guilds', guildId, 'auto-moderation', 'rules']).path;
  ...
  /// ```
  String update(String guildId, String ruleId) =>
      Uri(pathSegments: ['guilds', guildId, 'auto-moderation', 'rules', ruleId]).path;
  ...
  /// ```
  String delete(String guildId, String ruleId) =>
      Uri(pathSegments: ['guilds', guildId, 'auto-moderation', 'rules', ruleId]).path;
}