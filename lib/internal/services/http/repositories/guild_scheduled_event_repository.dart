final class GuildScheduledEventRepository {
  ...
  /// ```
  String get({ required String guildId, required String eventId }) =>
  ...
  /// ```
  String update({ required String guildId, required String eventId }) =>
      Uri(pathSegments: ['guilds', guildId, 'scheduled-events', eventId]).path;
  ...
  /// ```
  String delete({ required String guildId, required String eventId }) =>
      Uri(pathSegments: ['guilds', guildId, 'scheduled-events', eventId]).path;
  ...
  /// ```
  String getUsers({ required String guildId, required String eventId }) =>
      Uri(pathSegments: ['guilds', guildId, 'scheduled-events', eventId, 'users']).path;
}