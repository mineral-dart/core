...
class ChannelManager implements CacheManager<Channel> {
  ...
  Future<TextChannel?> createTextChannel ({ required String label, String? description, int? delay, int? position, CategoryChannel? categoryChannel, bool? nsfw,  List<PermissionOverwrite>? permissions}) async {
  ...
  Future<VoiceChannel?> createVoiceChannel ({ required String label, int? position, CategoryChannel? categoryChannel, int? bitrate, int? maxUsers, List<PermissionOverwrite>? permissions }) async {
  ...
  Future<CategoryChannel?> createCategoryChannel ({ required String label, int? position, List<PermissionOverwrite>? permissions }) async {
