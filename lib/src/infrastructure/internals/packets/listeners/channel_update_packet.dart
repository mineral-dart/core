...
final class ChannelUpdatePacket implements ListenablePacket {
  ...
  Future<void> listen(ShardMessage message, DispatchEvent dispatch) async {
    ...
    return switch (channel) {
      ServerChannel() => dispatch(event: Event.serverChannelUpdate, params: [before, channel]),
      PrivateChannel() => dispatch(event: Event.privateChannelUpdate, params: [before, channel]),
